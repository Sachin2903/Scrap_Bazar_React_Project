...
import logo2 from "../../../image/background/b.jpg"
import logo3 from "../../../image/background/c.jpg"
import logo4 from "../../../image/background/d.jpg"
...
const sliderdata=[{imgsrc:logo1,naam:"Ladakh"},{imgsrc:logo2,naam:"Delhi"},{imgsrc:logo3,naam:"Gujarat"},{imgsrc:logo4,naam:"Delhi"},{imgsrc:logo5,naam:"Agra"},{imgsrc:logo6,naam:"Tamil Nadu"},{imgsrc:logo7,naam:"Mumbai"},{imgsrc:logo8 ,naam:"Rajasthan"},{imgsrc:logo9,naam:"Kerala"},{imgsrc:logo10,naam:"Delhi"},{imgsrc:logo11,naam:"Ladakh"},{imgsrc:logo12,naam:"Panjab"},{imgsrc:logo13,naam:"Ladakh"}]
   ...
   return(
    <Fragment>
        <div className={styles.sliderdiv}>
            ...
            {
                sliderdata.map((e)=> <Slidelist detail={e}/> )
              }
